...
class CodeNamesEvents extends EventEmitter {
  ...
  fetch() {
    return wretch(`https://2047a3534542.ngrok.io/projects/code_names/${this.code_name_id}/ajax`)
      .get()
      .json((body) => body)
  ...
  updateGuessCard({word, guesses, turn}) {
    wretch(`https://2047a3534542.ngrok.io/projects/code_names/${this.code_name_id}/ajax`)
      .post({
        word,
        guesses,
        turn
